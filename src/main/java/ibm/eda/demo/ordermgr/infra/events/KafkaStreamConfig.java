...
public class KafkaStreamConfig {
    ...
    @ConfigProperty(name="application.id",defaultValue = "OrderAggregator")
    ...
    public Properties getStreamsProperties(){
		...
		properties.put(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, io.apicurio.registry.serde.avro.AvroSerde.class);
